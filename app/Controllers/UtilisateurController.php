...
class UtilisateurController extends Controller
{
    ...
    public function deleteForm(string $id): void
    {
        ...
        $this->view('confirm/index', [
            'confirmTitle'   => 'Supprimer le compte de ' . $utilisateur['prenom'] . ' ' . $utilisateur['nom'],
            'confirmMessage' => 'Vous êtes sur le point de supprimer ce compte utilisateur.',
            'confirmMessage2' => 'Cette action est définitive et irréversible.',
            'confirmIcon'    => 'fa-trash',
            'confirmPost'    => BASE_URL . 'utilisateurs/supprimer/' . $id,
            'confirmButton'  => 'Supprimer l\'utilisateur',
            'confirmButtonClass' => 'btn-danger-ghost',
            'confirmButtonIcon'  => 'fa-trash',
            'backUrl'        => BASE_URL . 'utilisateurs',
            'backLabel'      => 'Retour à la liste',
            'confirmRows'    => [
                ['label' => 'Nom complet', 'value' => $utilisateur['prenom'] . ' ' . $utilisateur['nom']],
                ['label' => 'E-mail',      'value' => $utilisateur['email']],
                ['label' => 'Rôle',        'value' => role_label($utilisateur['role'])],
                ['label' => 'Créé le',     'value' => datetime_fr($utilisateur['cree_le'])],
            ],
        ]);
    }
