...
$confetti = \App\Core\Session::get('confetti');
\App\Core\Session::remove('confetti');
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body class="page-dashboard"<?= $confetti ? ' data-confetti="1"' : '' ?>>
    ...
    <div class="app-main">
        <header class="topbar">
            ...
            <div class="topbar-title">
                ...
                <p><?= e(date_longue_fr(date('Y-m-d'))) ?> · <?= e(date('H:i')) ?></p>
            </div>
        ...
        <div class="dash-wave"><?php require __DIR__ . '/../partials/wave.php'; ?></div>
