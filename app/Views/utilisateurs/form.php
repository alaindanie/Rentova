    ...
    <form method="post" action="<?= BASE_URL . ($isEdit ? 'utilisateurs/modifier/' . $utilisateur['id'] : 'utilisateurs') ?>" class="form" enctype="multipart/form-data" novalidate>
        ...
        <div class="form-grid-2">
            <div class="field">
                ...
                <div class="input-wrap"><i class="fas fa-user"></i>
                    <input type="text" id="prenom" name="prenom" value="<?= e($utilisateur['prenom'] ?? '') ?>" placeholder="Prénom" data-validate="required|min:2">
                </div>
            ...
            <div class="field">
                ...
                <div class="input-wrap"><i class="fas fa-user"></i>
                    <input type="text" id="nom" name="nom" value="<?= e($utilisateur['nom'] ?? '') ?>" placeholder="Nom" data-validate="required|min:2">
                </div>
                <span class="field-error"></span>
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="input-wrap"><i class="fas fa-envelope"></i>
                <input type="email" id="email" name="email" value="<?= e($utilisateur['email'] ?? '') ?>" placeholder="vous@exemple.fr" data-validate="required|email">
            </div>
            <span class="field-error"></span>
        </div>
        ...
        <div class="form-grid-2">
            <div class="field">
                ...
                <div class="input-wrap"><i class="fas fa-user-shield"></i>
                    <select id="role" name="role" data-validate="required">
            ...
            <div class="field">
                ...
                <div class="input-wrap"><i class="fas fa-lock"></i>
                    <input type="password" id="password" name="password" placeholder="<?= $isEdit ? '••••••••' : '6 caractères min.' ?>" <?= $isEdit ? 'data-validate="min:6"' : 'data-validate="required|min:6"' ?> autocomplete="new-password">
