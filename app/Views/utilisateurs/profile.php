        ...
        <form method="post" action="<?= BASE_URL ?>profil" class="form" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-grid-2">
                <div class="field">
                    ...
                    <div class="input-wrap"><i class="fas fa-user"></i>
                        <input type="text" id="prenom" name="prenom" value="<?= e($utilisateur['prenom']) ?>">
                    </div>
                    <span class="field-error"></span>
                </div>
                <div class="field">
                    ...
                    <div class="input-wrap"><i class="fas fa-user"></i>
                        <input type="text" id="nom" name="nom" value="<?= e($utilisateur['nom']) ?>">
                    </div>
                    <span class="field-error"></span>
                </div>
            </div>
            <div class="field">
                ...
                <div class="input-wrap"><i class="fas fa-envelope"></i>
                    <input type="email" id="email" name="email" value="<?= e($utilisateur['email']) ?>">
                </div>
                <span class="field-error"></span>
            </div>
            <div class="form-grid-2">
