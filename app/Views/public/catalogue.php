...
<section class="page-hero page-hero-sm" data-glow>
    ...
    <div class="container">
        ...
        <h1>Nos équipements <span class="grad-text anim">disponibles</span></h1>
    ...
    <div class="container">
        <form method="get" action="<?= BASE_URL ?>catalogue" class="filter-panel reveal" data-filter-form>
            ...
            <div class="filter-row filter-row-advanced">
                <div class="filter-field"><label>Prix min</label><input type="number" name="prix_min" value="<?= e($filters['prix_min']) ?>" placeholder="0 €"></div>
                <div class="filter-field"><label>Prix max</label><input type="number" name="prix_max" value="<?= e($filters['prix_max']) ?>" placeholder="250 €"></div>
